  ...
  return (
    ...
    >
      ...
      >
        ...
        {getText({ zh: '新标签页打开', en: 'Open in new tab' }, lang)}
      </button>
      ...
      >
        ...
        {getText({ zh: '复制链接', en: 'Copy link' }, lang)}
      </button>
        ...
        <div className="relative">
          ...
          >
            <span className="flex items-center gap-2">
              ...
              {getText({ zh: '移动到分组', en: 'Move to group' }, lang)}
            </span>
